...
public class Demo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.LogFormat("Start scan ({0}) services", selectedDeviceId);
    ...
    void Update()
    {
        ...
        //Debug.Log("isScanningDevices: " + isScanningDevices);
            ...
            do
            {
                ...
                if (status == BleApi.ScanStatus.AVAILABLE)
                {
                    ...
                    if (devices[res.id]["name"] != "" && devices[res.id]["isConnectable"] == "True")
                    {
                        ...
                        Debug.Log("Device name: " + devices[res.id]["name"] + ", ID: " + res.id);
                    }
                }
        ...
        if (isScanningServices)
        {
            ...
            do
            {
                ...
                Debug.LogFormat("Find service ({0}): {1}", status, res.uuid);
            } while (status == BleApi.ScanStatus.AVAILABLE);
        }
    ...
    public void StartServiceScan()
    {
        if (!isScanningServices)
        {
            ...
            Debug.Log("selectedDeviceId: " + selectedDeviceId);
    ...
    public void Subscribe()
    {
        ...
        bool res = BleApi.SubscribeCharacteristic(selectedDeviceId, selectedServiceId, selectedCharacteristicId, false);
